            ...
            <div class="col-md-12">
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">ADD SUB TASK FOR <span class="text-warning">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span></h3>
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 150px;">
                      <div class="input-group-append">
                        <a href="subtasks.php" class="btn btn-block bg-gradient-success btn-lg">SUB TASKS LIST</a>
                      </div>
                    </div>
                  </div>
                </div>
                <form role="form" id="distrobutorForm" method="POST">
                  <div class="card-body row">
                    <div class="form-group col-lg-8 col-md-6 col-sm-12">
                      <label for="tasktitle">Sub Task Title</label>
                    ...
                    <div class="form-group col-12">
                      <label for="taskdependency">Sub Task Dependency</label>
