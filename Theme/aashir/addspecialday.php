              ...
              <div class="col-md-12">
                <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title">ADD SPECIAL DAY DIET: <b class="text-warning">RAM NAVMI</b></h3>
                    <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 150px;">
                      <div class="input-group-append">
                        <a href="specialDay.php" class="btn btn-block bg-gradient-success btn-lg">SPECIAL DAY LIST</a>
                      </div>
                    </div>
                  </div>
                  </div>
