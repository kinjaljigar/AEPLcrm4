...
<html>
  <head>
     <title>Aashir Engineering | Employee Report</title>
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Employee Work Report: | From Date: <input type="text" style="width:100px;"> <i class="fa fa-calendar-alt" aria-hidden="true"></i>  - To Date: <input type="text" style="width:100px;"> <i class="fa fa-calendar-alt" aria-hidden="true"></i></h3>
