...
<div class="content-wrapper">
    ...
    <?php if ($view_data['authorization']->is_role_allowed($view_data['admin_session']['u_type'], ['TaskCoordinator'])) { ?>
    ...
    <?php if ($view_data['authorization']->is_bim_head_or_higher($view_data['admin_session'])) { ?>
...
<script>
    ...
    function document_ready() {
        ...
        <?php if ($view_data['authorization']->is_role_allowed($view_data['admin_session']['u_type'], ['Master Admin'])) { ?>LoadWatch();
    <?php } ?>
