                ...
                switch ($act) {
                        ...
                        case "add":
                                ...
                                if ($l_id > 0) {
                                        ...
                                        $me_text = "<b> Department  - " .  $results[0]['Department'] . "</b> <br/><b> Leave Date Is Update By - " .  $results[0]['Username'] . "</b> <br/>Message - " . $l_message . "<br/>
                                        Existing DateFrom : " . $existingLeave[0]['l_from_date'] . " && Existing ToDate : " . $existingLeave[0]['l_to_date'] . "
                                         <br/>New Leave FromDate : " . convert_display2db($l_from_date) . " && New Leave ToDate : " . convert_display2db($l_to_date);
                        ...
                        switch ($type) {
                                ...
                                case 'leaves':
                                        ...
                                        foreach ($records as $single_record) {
                                                ...
                                                $anchors = "";
                                                if (($this->admin_session['u_type'] == 'Master Admin' || $this->admin_session['u_type'] == 'Bim Head' || $this->admin_session['u_type'] == 'Project Leader') && $single_record['l_status'] == 'Pending') {
                                                        $anchors .= '<a href="javascript://" class="btn btn-success btn-md" onClick="Approve(\'' . $single_record['l_id'] . '\',\'Approve\')"><i class="fa fa-thumbs-up"></i><a>&nbsp; ';
                                                        $anchors .= '<a href="javascript://" class="btn btn-danger btn-md" onClick="Approve(\'' . $single_record['l_id'] . '\',\'Decline\')"><i class="fa fa-thumbs-down"></i><a>';
                                                }
                                                $nestedData[] = $anchors;
