    ...
    <div class="wrapper">
                ...
                <a href="#"><i class="fa fa-circle text-success"></i> Online</a>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        if ($view_data['admin_session']['u_type'] == 'Master Admin') {
                            ...
                            if ($this->authorization->is_role_allowed($view_data['admin_session']['u_type'], ['TaskCoordinator'])) {
                                $menu['dashboard'] = array('Dashboard', 'home/index', 'fa-dashboard');
                            } else if ($this->authorization->is_role_allowed($view_data['admin_session']['u_type'], ['MailCoordinator'])) {
                                //$menu['dashboard'] = array('Dashboard', 'home/index', 'fa-dashboard');
        ...
        <div class="content-wrapper">
            ...
            <div id="messageContainer">
                <?php
                if (!empty($this->session->userdata('messages'))) {
