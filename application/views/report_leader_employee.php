...
$monday = $this->view_data['rpt_start'] ?? date('d-m-Y', strtotime('monday this week'));
$friday = $this->view_data['rpt_end'] ?? date('d-m-Y', strtotime('friday this week'));
$leader_id = $this->view_data['leader_id'];
