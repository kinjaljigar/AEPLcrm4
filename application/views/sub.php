            ...
            <div class="box-header">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php if(!$this->general->ValidateTaskAddEdit(0, $view_data['t_id'], $view_data['admin_session'])) { ?>
                            <a href="<?php echo base_url('home/task/add/'.$view_data['project']['p_id'].'/'.$view_data['t_id']);?>" class="btn btn-primary pull-right">Add New Subtask</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
