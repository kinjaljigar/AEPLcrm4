 ...
 * Centralized user access control and permission management
 */
class Authorization
{
    private $CI;
     ...
     */
    public function check_page_access($method, $user_session, $redirect_url = 'home/tasks')
    {
     ...
     * @return bool
     */
    public function is_role_allowed($user_role, $allowed_roles)
    {
     ...
     * @return bool
     */
    public function has_minimum_role($user_role, $minimum_role)
    {
     ...
     * @return bool
     */
    public function is_admin($user_session_or_type)
    {
     ...
     * @return bool
     */
    public function is_super_admin($user_session_or_type)
    {
        $user_type = is_array($user_session_or_type)
            ? ($user_session_or_type['u_type'] ?? null)
            : $user_session_or_type;
     ...
     * @return bool
     */
    public function is_bim_head_or_higher($user_session_or_type)
    {
        $user_type = is_array($user_session_or_type)
            ? ($user_session_or_type['u_type'] ?? null)
            : $user_session_or_type;
    ...
    public function is_bim_head_or_high_taskcoordinator($user_session_or_type)
    {
        $user_type = is_array($user_session_or_type)
            ? ($user_session_or_type['u_type'] ?? null)
            : $user_session_or_type;
     ...
     * @return bool
     */
    public function is_project_leader_or_higher($user_session_or_type)
    {
        $user_type = is_array($user_session_or_type)
            ? ($user_session_or_type['u_type'] ?? null)
            : $user_session_or_type;
     ...
     * @return bool
     */
    public function require_roles($user_session_or_type, $allowed_roles, $redirect_url = 'home/tasks')
    {
        $user_type = is_array($user_session_or_type)
            ? ($user_session_or_type['u_type'] ?? null)
            : $user_session_or_type;
     ...
     */
    public function get_role_level($user_role)
    {
     ...
     * @return bool
     */
    public function can_manage_projects($user_session_or_type)
    {
     ...
     * @return bool
     */
    public function can_view_all_data($user_session_or_type)
    {
